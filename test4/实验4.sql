...
下面是创建用户tu_peng
CREATE USER tu_peng IDENTIFIED BY 123
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";

-- QUOTAS
ALTER USER tu_peng QUOTA UNLIMITED ON USERS;
ALTER USER tu_peng QUOTA UNLIMITED ON USERS02;
ALTER USER tu_peng ACCOUNT UNLOCK;

-- ROLES
GRANT "CONNECT" TO tu_peng WITH ADMIN OPTION;
GRANT "RESOURCE" TO tu_peng WITH ADMIN OPTION;
ALTER USER tu_peng DEFAULT ROLE "CONNECT","RESOURCE";

-- SYSTEM PRIVILEGES
GRANT CREATE VIEW TO tu_peng WITH ADMIN OPTION;
